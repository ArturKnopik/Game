...
Mario::GumbaGameobject::GumbaGameobject(sf::Vector2f position, sf::Vector2f size)
	:Mario::Gameobject(position, size)
{
...
void Mario::GumbaGameobject::update(const double dt)
{
...
void Mario::GumbaGameobject::onCollision(std::shared_ptr<Mario::Gameobject> other)
{
