...
Mario::MarioGameObiect::MarioGameObiect(sf::Vector2f position, sf::Vector2f size)
	:GameObiect(sf::Vector2f(100,100), sf::Vector2f(32,32))
{
...
Mario::MarioGameObiect::~MarioGameObiect()
{

}

void Mario::MarioGameObiect::onCollision(std::shared_ptr<Mario::GameObiect> other)
{
