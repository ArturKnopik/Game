...
GameListState::GameListState(std::shared_ptr<Game> game)
{
	...
	this->game = game;	
	gameListButtons.push_back(std::unique_ptr<Button>(new BasicButton("PLAYSTATE", sf::Vector2f(100, 100), sf::Vector2f(600, 50), 50, sf::Color(0, 100, 200, 150), sf::Color(255, 0, 0, 180))));
